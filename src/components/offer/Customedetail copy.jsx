...
function CustomeDetail() {
    const { id,SKU} = useParams(); // SKU for displaying, id for posting order
    ...
    return (
        <section class="fz-product-details bg-gry-1">
        <div className="container">
            {isLoading ? (
                ...
                <div className='row'>
                    ...
                    <div className='col-lg-7 col-md-6 col-12 col-xxs-12'>
