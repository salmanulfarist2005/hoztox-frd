...
const ViewOrderAccept = () => {
    ...
    ProductCategory: selectedItem.item?.product?.category?.category_name || selectedItem.item?.product?.category_name || '',
...
export default ViewOrderAccept;
