...
import { Button, Card, CardBody, Form, CardHeader, Col, Container, Row, Modal, ModalBody, ModalFooter, ModalHeader, Input } from 'reactstrap';
...
const FullStatus = () => {
    ...
    const handleCSVUpload = async () => {
        ...
        try {
            const response = await axios.post(`${BASE_URL}/products/full-status/upload-csv/`, formData, {
                headers: {
